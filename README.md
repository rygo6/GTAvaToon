...
A few major unique features and technical points:
...
- Toon outlines appear thinner in the Game View than they do in VR. I am still trying to figure exactly what causes this and offset it. Or if I should even offset it, it might just be perceptual due to VR focusing on a smaller area of the screen. But keep in mind the outline is about roughly ~30% thicker in VR.
