...
- `Light Probe Averaging` This lets you average incoming light probe data in case you want less light variation coming from the world. If you set this fully to 100 then world lighting will fall across your avatar uniformly and it largely becomes a way to have the brightness of your avatar match the world brightness. _You need to actually bake down some light probes in your scene with varying levels and colors to see any affect from changing this._
